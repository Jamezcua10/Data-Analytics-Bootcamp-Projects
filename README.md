...
| [Analyzing borrowers' risk of defaulting](Bank Loan Analysis)
| Preparing a report for a bank’s loan division. The goal of the analysis is to find out if a customer’s marital status and number of children has an impact on whether they will default on a loan. | *pandas*
